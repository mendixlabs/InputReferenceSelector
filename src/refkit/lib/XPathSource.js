dojo.provide("refkit.lib.XPathSource");

dojo.require("dojo.data.util.simpleFetch");


dojo.declare("refkit.lib.XPathSource", null, {
  limit       : 5,
    method      : "",
    xpath       : "",
    emptys      : true,
    ...
    constructor : function(kwArgs) {
        ...
        this.atype = /AutoNumber|Integer|Long/.test(type)
            ? "integer"
...
dojo.extend(refkit.lib.XPathSource, dojo.data.util.simpleFetch);
